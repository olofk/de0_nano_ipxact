...
wire [31:0] wb_m2s_dbus_sdram_dbus_adr;
wire [31:0] wb_m2s_dbus_sdram_dbus_dat;
wire  [3:0] wb_m2s_dbus_sdram_dbus_sel;
wire        wb_m2s_dbus_sdram_dbus_we;
wire        wb_m2s_dbus_sdram_dbus_cyc;
wire        wb_m2s_dbus_sdram_dbus_stb;
wire  [2:0] wb_m2s_dbus_sdram_dbus_cti;
wire  [1:0] wb_m2s_dbus_sdram_dbus_bte;
wire [31:0] wb_s2m_dbus_sdram_dbus_dat;
wire        wb_s2m_dbus_sdram_dbus_ack;
wire        wb_s2m_dbus_sdram_dbus_err;
wire        wb_s2m_dbus_sdram_dbus_rty;
wire [31:0] wb_m2s_dbus_uart0_adr;
wire [31:0] wb_m2s_dbus_uart0_dat;
wire  [3:0] wb_m2s_dbus_uart0_sel;
wire        wb_m2s_dbus_uart0_we;
wire        wb_m2s_dbus_uart0_cyc;
wire        wb_m2s_dbus_uart0_stb;
wire  [2:0] wb_m2s_dbus_uart0_cti;
wire  [1:0] wb_m2s_dbus_uart0_bte;
wire [31:0] wb_s2m_dbus_uart0_dat;
wire        wb_s2m_dbus_uart0_ack;
wire        wb_s2m_dbus_uart0_err;
wire        wb_s2m_dbus_uart0_rty;
wire [31:0] wb_m2s_dbus_gpio0_adr;
wire [31:0] wb_m2s_dbus_gpio0_dat;
wire  [3:0] wb_m2s_dbus_gpio0_sel;
wire        wb_m2s_dbus_gpio0_we;
wire        wb_m2s_dbus_gpio0_cyc;
wire        wb_m2s_dbus_gpio0_stb;
wire  [2:0] wb_m2s_dbus_gpio0_cti;
wire  [1:0] wb_m2s_dbus_gpio0_bte;
wire [31:0] wb_s2m_dbus_gpio0_dat;
wire        wb_s2m_dbus_gpio0_ack;
wire        wb_s2m_dbus_gpio0_err;
wire        wb_s2m_dbus_gpio0_rty;
wire [31:0] wb_m2s_dbus_spi0_adr;
wire [31:0] wb_m2s_dbus_spi0_dat;
wire  [3:0] wb_m2s_dbus_spi0_sel;
wire        wb_m2s_dbus_spi0_we;
wire        wb_m2s_dbus_spi0_cyc;
wire        wb_m2s_dbus_spi0_stb;
wire  [2:0] wb_m2s_dbus_spi0_cti;
wire  [1:0] wb_m2s_dbus_spi0_bte;
wire [31:0] wb_s2m_dbus_spi0_dat;
wire        wb_s2m_dbus_spi0_ack;
wire        wb_s2m_dbus_spi0_err;
wire        wb_s2m_dbus_spi0_rty;
...
wb_mux
  #(.num_slaves (4),
    .MATCH_ADDR ({32'h00000000, 32'h90000000, 32'h91000000, 32'hb0000000}),
    .MATCH_MASK ({32'hfe000000, 32'hffffffe0, 32'hfffffffe, 32'hfffffff8}))
 wb_mux_dbg
   (.wb_clk_i  (wb_clk_i),
    .wb_rst_i  (wb_rst_i),
    ...
    .wbs_adr_o ({wb_m2s_dbg_sdram_dbus_adr, wb_m2s_dbg_uart0_adr, wb_m2s_dbg_gpio0_adr, wb_m2s_dbg_spi0_adr}),
    .wbs_dat_o ({wb_m2s_dbg_sdram_dbus_dat, wb_m2s_dbg_uart0_dat, wb_m2s_dbg_gpio0_dat, wb_m2s_dbg_spi0_dat}),
    .wbs_sel_o ({wb_m2s_dbg_sdram_dbus_sel, wb_m2s_dbg_uart0_sel, wb_m2s_dbg_gpio0_sel, wb_m2s_dbg_spi0_sel}),
    .wbs_we_o  ({wb_m2s_dbg_sdram_dbus_we, wb_m2s_dbg_uart0_we, wb_m2s_dbg_gpio0_we, wb_m2s_dbg_spi0_we}),
    .wbs_cyc_o ({wb_m2s_dbg_sdram_dbus_cyc, wb_m2s_dbg_uart0_cyc, wb_m2s_dbg_gpio0_cyc, wb_m2s_dbg_spi0_cyc}),
    .wbs_stb_o ({wb_m2s_dbg_sdram_dbus_stb, wb_m2s_dbg_uart0_stb, wb_m2s_dbg_gpio0_stb, wb_m2s_dbg_spi0_stb}),
    .wbs_cti_o ({wb_m2s_dbg_sdram_dbus_cti, wb_m2s_dbg_uart0_cti, wb_m2s_dbg_gpio0_cti, wb_m2s_dbg_spi0_cti}),
    .wbs_bte_o ({wb_m2s_dbg_sdram_dbus_bte, wb_m2s_dbg_uart0_bte, wb_m2s_dbg_gpio0_bte, wb_m2s_dbg_spi0_bte}),
    .wbs_dat_i ({wb_s2m_dbg_sdram_dbus_dat, wb_s2m_dbg_uart0_dat, wb_s2m_dbg_gpio0_dat, wb_s2m_dbg_spi0_dat}),
    .wbs_ack_i ({wb_s2m_dbg_sdram_dbus_ack, wb_s2m_dbg_uart0_ack, wb_s2m_dbg_gpio0_ack, wb_s2m_dbg_spi0_ack}),
    .wbs_err_i ({wb_s2m_dbg_sdram_dbus_err, wb_s2m_dbg_uart0_err, wb_s2m_dbg_gpio0_err, wb_s2m_dbg_spi0_err}),
    .wbs_rty_i ({wb_s2m_dbg_sdram_dbus_rty, wb_s2m_dbg_uart0_rty, wb_s2m_dbg_gpio0_rty, wb_s2m_dbg_spi0_rty}));
...
wb_mux
  #(.num_slaves (5),
    .MATCH_ADDR ({32'h00000000, 32'h90000000, 32'h91000000, 32'ha1000000, 32'hb0000000}),
    .MATCH_MASK ({32'hfe000000, 32'hffffffe0, 32'hfffffffe, 32'hfffffff8, 32'hfffffff8}))
 wb_mux_dbus
   (.wb_clk_i  (wb_clk_i),
    .wb_rst_i  (wb_rst_i),
    ...
    .wbs_adr_o ({wb_m2s_dbus_sdram_dbus_adr, wb_m2s_dbus_uart0_adr, wb_m2s_dbus_gpio0_adr, wb_m2s_resize_i2c1_adr, wb_m2s_dbus_spi0_adr}),
    .wbs_dat_o ({wb_m2s_dbus_sdram_dbus_dat, wb_m2s_dbus_uart0_dat, wb_m2s_dbus_gpio0_dat, wb_m2s_resize_i2c1_dat, wb_m2s_dbus_spi0_dat}),
    .wbs_sel_o ({wb_m2s_dbus_sdram_dbus_sel, wb_m2s_dbus_uart0_sel, wb_m2s_dbus_gpio0_sel, wb_m2s_resize_i2c1_sel, wb_m2s_dbus_spi0_sel}),
    .wbs_we_o  ({wb_m2s_dbus_sdram_dbus_we, wb_m2s_dbus_uart0_we, wb_m2s_dbus_gpio0_we, wb_m2s_resize_i2c1_we, wb_m2s_dbus_spi0_we}),
    .wbs_cyc_o ({wb_m2s_dbus_sdram_dbus_cyc, wb_m2s_dbus_uart0_cyc, wb_m2s_dbus_gpio0_cyc, wb_m2s_resize_i2c1_cyc, wb_m2s_dbus_spi0_cyc}),
    .wbs_stb_o ({wb_m2s_dbus_sdram_dbus_stb, wb_m2s_dbus_uart0_stb, wb_m2s_dbus_gpio0_stb, wb_m2s_resize_i2c1_stb, wb_m2s_dbus_spi0_stb}),
    .wbs_cti_o ({wb_m2s_dbus_sdram_dbus_cti, wb_m2s_dbus_uart0_cti, wb_m2s_dbus_gpio0_cti, wb_m2s_resize_i2c1_cti, wb_m2s_dbus_spi0_cti}),
    .wbs_bte_o ({wb_m2s_dbus_sdram_dbus_bte, wb_m2s_dbus_uart0_bte, wb_m2s_dbus_gpio0_bte, wb_m2s_resize_i2c1_bte, wb_m2s_dbus_spi0_bte}),
    .wbs_dat_i ({wb_s2m_dbus_sdram_dbus_dat, wb_s2m_dbus_uart0_dat, wb_s2m_dbus_gpio0_dat, wb_s2m_resize_i2c1_dat, wb_s2m_dbus_spi0_dat}),
    .wbs_ack_i ({wb_s2m_dbus_sdram_dbus_ack, wb_s2m_dbus_uart0_ack, wb_s2m_dbus_gpio0_ack, wb_s2m_resize_i2c1_ack, wb_s2m_dbus_spi0_ack}),
    .wbs_err_i ({wb_s2m_dbus_sdram_dbus_err, wb_s2m_dbus_uart0_err, wb_s2m_dbus_gpio0_err, wb_s2m_resize_i2c1_err, wb_s2m_dbus_spi0_err}),
    .wbs_rty_i ({wb_s2m_dbus_sdram_dbus_rty, wb_s2m_dbus_uart0_rty, wb_s2m_dbus_gpio0_rty, wb_s2m_resize_i2c1_rty, wb_s2m_dbus_spi0_rty}));
...
wb_arbiter
 ...
 wb_arbiter_sdram_dbus
   (.wb_clk_i  (wb_clk_i),
    .wb_rst_i  (wb_rst_i),
    .wbm_adr_i ({wb_m2s_dbg_sdram_dbus_adr, wb_m2s_dbus_sdram_dbus_adr}),
    .wbm_dat_i ({wb_m2s_dbg_sdram_dbus_dat, wb_m2s_dbus_sdram_dbus_dat}),
    .wbm_sel_i ({wb_m2s_dbg_sdram_dbus_sel, wb_m2s_dbus_sdram_dbus_sel}),
    .wbm_we_i  ({wb_m2s_dbg_sdram_dbus_we, wb_m2s_dbus_sdram_dbus_we}),
    .wbm_cyc_i ({wb_m2s_dbg_sdram_dbus_cyc, wb_m2s_dbus_sdram_dbus_cyc}),
    .wbm_stb_i ({wb_m2s_dbg_sdram_dbus_stb, wb_m2s_dbus_sdram_dbus_stb}),
    .wbm_cti_i ({wb_m2s_dbg_sdram_dbus_cti, wb_m2s_dbus_sdram_dbus_cti}),
    .wbm_bte_i ({wb_m2s_dbg_sdram_dbus_bte, wb_m2s_dbus_sdram_dbus_bte}),
    .wbm_dat_o ({wb_s2m_dbg_sdram_dbus_dat, wb_s2m_dbus_sdram_dbus_dat}),
    .wbm_ack_o ({wb_s2m_dbg_sdram_dbus_ack, wb_s2m_dbus_sdram_dbus_ack}),
    .wbm_err_o ({wb_s2m_dbg_sdram_dbus_err, wb_s2m_dbus_sdram_dbus_err}),
    .wbm_rty_o ({wb_s2m_dbg_sdram_dbus_rty, wb_s2m_dbus_sdram_dbus_rty}),
...
wb_arbiter
 ...
 wb_arbiter_uart0
   (.wb_clk_i  (wb_clk_i),
    .wb_rst_i  (wb_rst_i),
    .wbm_adr_i ({wb_m2s_dbg_uart0_adr, wb_m2s_dbus_uart0_adr}),
    .wbm_dat_i ({wb_m2s_dbg_uart0_dat, wb_m2s_dbus_uart0_dat}),
    .wbm_sel_i ({wb_m2s_dbg_uart0_sel, wb_m2s_dbus_uart0_sel}),
    .wbm_we_i  ({wb_m2s_dbg_uart0_we, wb_m2s_dbus_uart0_we}),
    .wbm_cyc_i ({wb_m2s_dbg_uart0_cyc, wb_m2s_dbus_uart0_cyc}),
    .wbm_stb_i ({wb_m2s_dbg_uart0_stb, wb_m2s_dbus_uart0_stb}),
    .wbm_cti_i ({wb_m2s_dbg_uart0_cti, wb_m2s_dbus_uart0_cti}),
    .wbm_bte_i ({wb_m2s_dbg_uart0_bte, wb_m2s_dbus_uart0_bte}),
    .wbm_dat_o ({wb_s2m_dbg_uart0_dat, wb_s2m_dbus_uart0_dat}),
    .wbm_ack_o ({wb_s2m_dbg_uart0_ack, wb_s2m_dbus_uart0_ack}),
    .wbm_err_o ({wb_s2m_dbg_uart0_err, wb_s2m_dbus_uart0_err}),
    .wbm_rty_o ({wb_s2m_dbg_uart0_rty, wb_s2m_dbus_uart0_rty}),
...
wb_arbiter
 ...
 wb_arbiter_gpio0
   (.wb_clk_i  (wb_clk_i),
    .wb_rst_i  (wb_rst_i),
    .wbm_adr_i ({wb_m2s_dbg_gpio0_adr, wb_m2s_dbus_gpio0_adr}),
    .wbm_dat_i ({wb_m2s_dbg_gpio0_dat, wb_m2s_dbus_gpio0_dat}),
    .wbm_sel_i ({wb_m2s_dbg_gpio0_sel, wb_m2s_dbus_gpio0_sel}),
    .wbm_we_i  ({wb_m2s_dbg_gpio0_we, wb_m2s_dbus_gpio0_we}),
    .wbm_cyc_i ({wb_m2s_dbg_gpio0_cyc, wb_m2s_dbus_gpio0_cyc}),
    .wbm_stb_i ({wb_m2s_dbg_gpio0_stb, wb_m2s_dbus_gpio0_stb}),
    .wbm_cti_i ({wb_m2s_dbg_gpio0_cti, wb_m2s_dbus_gpio0_cti}),
    .wbm_bte_i ({wb_m2s_dbg_gpio0_bte, wb_m2s_dbus_gpio0_bte}),
    .wbm_dat_o ({wb_s2m_dbg_gpio0_dat, wb_s2m_dbus_gpio0_dat}),
    .wbm_ack_o ({wb_s2m_dbg_gpio0_ack, wb_s2m_dbus_gpio0_ack}),
    .wbm_err_o ({wb_s2m_dbg_gpio0_err, wb_s2m_dbus_gpio0_err}),
    .wbm_rty_o ({wb_s2m_dbg_gpio0_rty, wb_s2m_dbus_gpio0_rty}),
...
wb_arbiter
 ...
 wb_arbiter_spi0
   (.wb_clk_i  (wb_clk_i),
    .wb_rst_i  (wb_rst_i),
    .wbm_adr_i ({wb_m2s_dbg_spi0_adr, wb_m2s_dbus_spi0_adr}),
    .wbm_dat_i ({wb_m2s_dbg_spi0_dat, wb_m2s_dbus_spi0_dat}),
    .wbm_sel_i ({wb_m2s_dbg_spi0_sel, wb_m2s_dbus_spi0_sel}),
    .wbm_we_i  ({wb_m2s_dbg_spi0_we, wb_m2s_dbus_spi0_we}),
    .wbm_cyc_i ({wb_m2s_dbg_spi0_cyc, wb_m2s_dbus_spi0_cyc}),
    .wbm_stb_i ({wb_m2s_dbg_spi0_stb, wb_m2s_dbus_spi0_stb}),
    .wbm_cti_i ({wb_m2s_dbg_spi0_cti, wb_m2s_dbus_spi0_cti}),
    .wbm_bte_i ({wb_m2s_dbg_spi0_bte, wb_m2s_dbus_spi0_bte}),
    .wbm_dat_o ({wb_s2m_dbg_spi0_dat, wb_s2m_dbus_spi0_dat}),
    .wbm_ack_o ({wb_s2m_dbg_spi0_ack, wb_s2m_dbus_spi0_ack}),
    .wbm_err_o ({wb_s2m_dbg_spi0_err, wb_s2m_dbus_spi0_err}),
    .wbm_rty_o ({wb_s2m_dbg_spi0_rty, wb_s2m_dbus_spi0_rty}),
